...
- [ ] Mood entry form: 5 large emoji/visual mood buttons, optional energy (1–5) and stress (1–5) controls, optional notes, date/time picker, `Save Entry` button — matching the wireframe.
