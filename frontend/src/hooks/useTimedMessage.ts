...
// out of the four Dashboard sections (Mood/Symptom/Medication/Habit) since all four need the
// exact same "say 'Saved.' then quietly go away" behavior for their post-save confirmation.
